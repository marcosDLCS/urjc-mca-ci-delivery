...
import static es.urjc.cloudapps.insurancecompany.clients.shared.ClientTestDataFactory.getValidClient;
...
class ClientsGetControllerTest {
    ...
    void ensure_controller_should_return_ok_when_receive_client_list() throws Exception {
        ...
        when(clientFinder.findAll()).thenReturn(List.of(getValidClient()));
    ...
    void ensure_controller_should_return_ok_when_receive_a_single_client() throws Exception {
        ...
        when(clientFinder.findOne(any())).thenReturn(getValidClient());
