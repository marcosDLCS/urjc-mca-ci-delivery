...
import static es.urjc.cloudapps.insurancecompany.unit.insurances.shared.InsuranceTestDataFactory.getValidInsurance;
...
class InsurancesGetControllerTest {
    ...
    void ensure_controller_should_return_ok_when_receive_insurance_list() throws Exception {
        ...
        when(insuranceFinder.findAll()).thenReturn(List.of(getValidInsurance()));
    ...
    void ensure_controller_should_return_ok_when_receive_a_single_insurance() throws Exception {
        ...
        when(insuranceFinder.findOne(any())).thenReturn(getValidInsurance());
