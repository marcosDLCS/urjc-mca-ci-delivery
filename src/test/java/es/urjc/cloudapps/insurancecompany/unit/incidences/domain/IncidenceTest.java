...
class IncidenceTest {
    ...
    void ensure_missing_incidence_id_throws_exception() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Incidence(null,
                IncidenceTestDataFactory.getValidInsuranceId(),
                IncidenceTestDataFactory.getValidCoverageIncidence(),
                IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED,
                "random-description"));
    }
    ...
    void ensure_missing_incidence_id_exception_has_correct_message() {
        ...
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> new Incidence(null, IncidenceTestDataFactory.getValidInsuranceId(),
                        IncidenceTestDataFactory.getValidCoverageIncidence(),
                        IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED, "random-description"));
    ...
    void ensure_missing_incidence_insurance_id_throws_exception() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(), null,
                IncidenceTestDataFactory.getValidCoverageIncidence(),
                        IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED,
                "random-description"));
    }
    ...
    void ensure_missing_incidence_coverage_incidence_throws_exception() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(),
                        IncidenceTestDataFactory.getValidInsuranceId(),
                null, IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED,
                "random-description"));
    }
    ...
    void ensure_missing_incidence_coverage_incidence_exception_has_correct_message() {
        ...
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(), IncidenceTestDataFactory.getValidInsuranceId(), null,
                        IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED, "random-description"));
    ...
    void ensure_missing_incidence_amount_throws_exception() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(), IncidenceTestDataFactory.getValidInsuranceId(),
                IncidenceTestDataFactory.getValidCoverageIncidence(), null, IncidenceStatus.ACCEPTED,
                "random-description"));
    }
    ...
    void ensure_missing_incidence_amount_exception_has_correct_message() {
        ...
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(), IncidenceTestDataFactory.getValidInsuranceId(), IncidenceTestDataFactory.getValidCoverageIncidence(),
    ...
    void ensure_missing_incidence_description_throws_exception(final String description) {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(),
                        IncidenceTestDataFactory.getValidInsuranceId(),
                IncidenceTestDataFactory.getValidCoverageIncidence(), IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED, description));
    }
    ...
    void ensure_missing_incidence_description_exception_has_correct_message(final String description) {
        ...
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> new Incidence(IncidenceTestDataFactory.getValidIncidenceId(), IncidenceTestDataFactory.getValidInsuranceId(), IncidenceTestDataFactory.getValidCoverageIncidence(),
                        IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED, description));
    ...
    void ensure_valid_params_returns_a_new_object() {
        ...
        assertThat(new Incidence(IncidenceTestDataFactory.getValidIncidenceId(), IncidenceTestDataFactory.getValidInsuranceId(),
                IncidenceTestDataFactory.getValidCoverageIncidence(), IncidenceTestDataFactory.getValidIncidenceAmount(), IncidenceStatus.ACCEPTED,
